...
export const metadata: Metadata = {
  ...
  keywords: ["cbz to epub", "epub", "comic book converter", "cbz", "pdf", "convert", "kindle", "manga", "comics", "to", "converter", "convert", "anime", "how to", "book", "convert cbz to pdf", "cbz to pdf", "how to convert cbz to pdf", "cbz to pdf tool", "tool", "CBZ to PDF Converter - Free Online Tool", "free", "free tool"],
  icons: {
    icon: [
